...
function updateCardContent() {
    ...
    document.getElementById('bleContent').classList.remove('card-content-show');
    ...
    } else if (currentNav === 'BLE') {
        document.getElementById('bleContent').classList.add('card-content-show');
        document.querySelector('.nav2').classList.add('currently-selected');
    }
}
